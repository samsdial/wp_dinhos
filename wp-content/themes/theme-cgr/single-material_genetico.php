...
<main class="full box_intro">
    <div class="box_intro--img" style="background-image: url(<?php echo get_field('banner_interna')[url]; ?>);"></div>
</main>
<main class="middle pd_top--x50 pd_bottom--x100">
    <section class="breadcrumb container pd_bottom--x10">
        <ul class="list_breadcrumb list--inline txt_upper">
            ...
            <li><a href="/cgr/material-genetico/"><?php echo get_field('raza'); ?></a></li>
                ...
                <div class="column box_next bgc--gainsboro va_t">
                    ...
                    <div class="content pd_box--x20 mg_bottom--x10 va_t">
                        <div class="title txt_upper cl--blue mg_bottom--x10">
                            <h2><?php echo get_field('raza'); ?> / <?php the_title(); ?></h2>
                        </div>
                        <div class="box_tap--item mg_bottom--x20">
                            <ul class="tabs_item list_tabs_item--inline">
                                <li class="active" data-tab="tabs_item_1"><a class="btn btn_tab btn--min"><span>Semen</span></a></li>
                                <li data-tab="tabs_item_2"><a class="btn btn_tab btn--min"><span>Embrion</span></a></li>
                            </ul>
                            <div class="active tabs_item-content pd_bottom--x20 mg_bottom--x50 pd_top--x20" id="tabs_item_1">
                                <p><?php echo get_field('semen'); ?></p>
                            </div>
                            <div class="tabs_item-content pd_bottom--x20 mg_bottom--x50 pd_top--x20" id="tabs_item_2">
                                <p><?php echo get_field('embrion'); ?></p>
                            </div>
        ...
        $('#interest<?php echo get_the_ID(); ?>').submit(function(){
            ...
            if(name=="" || email=="" || phone=="" || message==""){
                ...
                if(!validacion_email.test(email)){
                    ...
                    $.ajax({
                        method:"Post",
                        url:"/wp-content/themes/theme-cgr/lib/interest.php",
                        dataType:"json",
                        data:{
